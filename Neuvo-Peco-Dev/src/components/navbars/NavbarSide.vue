	...
	<nav class="navbar navbar-light navbar-vertical navbar-expand-xl">
		<div class="d-flex align-items-center">
			<div class="toggle-icon-wrapper">
				<NavbarToggle class="navbar-vertical-toggle" data-bs-toggle="tooltip" data-bs-placement="left"
				...
				<ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
						...
						<ul class="nav collapse show" id="dashboard">
							...
							<li class="nav-item">
								<a class="nav-link" href="dashboard/support-desk.html">
									<div class="d-flex align-items-center">
										<span class="nav-link-text ps-1">Support desk</span><span
											class="badge rounded-pill ms-2 badge-subtle-success">New</span>
									</div>
								</a>
								<!-- more inner pages-->
					...
					<li class="nav-item">
						...
						<!-- parent pages--><a class="nav-link dropdown-indicator" href="#email" role="button"
							...
							<div class="d-flex align-items-center">
								<span class="nav-link-icon"><span class="fas fa-envelope-open"></span></span><span
						...
						<!-- parent pages--><a class="nav-link dropdown-indicator" href="#events" role="button"
							...
							<div class="d-flex align-items-center">
								<span class="nav-link-icon"><span class="fas fa-calendar-day"></span></span><span
						...
						<!-- parent pages--><a class="nav-link dropdown-indicator" href="#e-commerce" role="button"
							...
							<div class="d-flex align-items-center">
								<span class="nav-link-icon"><span class="fas fa-shopping-cart"></span></span><span
						...
						<!-- parent pages--><a class="nav-link dropdown-indicator" href="#e-learning" role="button"
							...
							<div class="d-flex align-items-center">
								<span class="nav-link-icon"><span class="fas fa-graduation-cap"></span></span><span
						...
						<!-- parent pages--><a class="nav-link dropdown-indicator" href="#social" role="button"
							...
							<div class="d-flex align-items-center">
								<span class="nav-link-icon"><span class="fas fa-share-alt"></span></span><span
						...
						<!-- parent pages--><a class="nav-link dropdown-indicator" href="#support-desk" role="button"
							...
							<div class="d-flex align-items-center">
								<span class="nav-link-icon"><span class="fas fa-ticket-alt"></span></span><span
					...
					<li class="nav-item">
						...
						<!-- parent pages--><a class="nav-link dropdown-indicator" href="#errors" role="button"
							...
							<div class="d-flex align-items-center">
								<span class="nav-link-icon"><span class="fas fa-exclamation-triangle"></span></span><span
						...
						<!-- parent pages--><a class="nav-link dropdown-indicator" href="#Layouts" role="button"
							...
							<div class="d-flex align-items-center">
								<span class="nav-link-icon"><span class="far fa-window-restore"></span></span><span
					...
					<li class="nav-item">
						...
						<!-- parent pages--><a class="nav-link dropdown-indicator" href="#tables" role="button"
							...
							<div class="d-flex align-items-center">
								<span class="nav-link-icon"><span class="fas fa-table"></span></span><span
								...
								<ul class="nav collapse" id="eCharts">
									...
									<li class="nav-item">
										<a class="nav-link" href="modules/charts/echarts/gauge-charts.html">
											<div class="d-flex align-items-center">
												<span class="nav-link-text ps-1">Gauge charts</span>
											</div>
										</a>
										<!-- more inner pages-->
									</li>
						...
						<!-- parent pages--><a class="nav-link dropdown-indicator" href="#icons" role="button"
							...
							<div class="d-flex align-items-center">
								<span class="nav-link-icon"><span class="fas fa-shapes"></span></span><span
						...
						<!-- parent pages--><a class="nav-link dropdown-indicator" href="#maps" role="button"
							...
							<div class="d-flex align-items-center">
								<span class="nav-link-icon"><span class="fas fa-map"></span></span><span
						...
						<!-- parent pages--><a class="nav-link dropdown-indicator" href="#components" role="button"
							...
							<div class="d-flex align-items-center">
								<span class="nav-link-icon"><span class="fas fa-puzzle-piece"></span></span><span
						...
						<ul class="nav collapse" id="components">
							...
							<li class="nav-item">
								<a class="nav-link" href="modules/components/bottom-bar.html">
									<div class="d-flex align-items-center">
										<span class="nav-link-text ps-1">Bottom bar</span><span
											class="badge rounded-pill ms-2 badge-subtle-success">New</span>
									</div>
								</a>
								<!-- more inner pages-->
							...
							<li class="nav-item">
								<a class="nav-link dropdown-indicator" href="#navs-_and_-Tabs" data-bs-toggle="collapse"
									aria-expanded="false" aria-controls="components">
									<div class="d-flex align-items-center">
						...
						<!-- parent pages--><a class="nav-link dropdown-indicator" href="#utilities" role="button"
							...
							<div class="d-flex align-items-center">
								<span class="nav-link-icon"><span class="fas fa-fire"></span></span><span
						...
						<ul class="nav collapse" id="utilities">
							...
							<li class="nav-item">
								<a class="nav-link" href="modules/utilities/focus-ring.html">
									<div class="d-flex align-items-center">
										<span class="nav-link-text ps-1">Focus ring</span>
									</div>
								</a>
								<!-- more inner pages-->
							</li>
							...
							<li class="nav-item">
								<a class="nav-link" href="modules/utilities/icon-link.html">
									<div class="d-flex align-items-center">
										<span class="nav-link-text ps-1">Icon link</span>
									</div>
								</a>
								<!-- more inner pages-->
							</li>
							<li class="nav-item">
								<a class="nav-link" href="modules/utilities/overlayscrollbar.html">
									<div class="d-flex align-items-center">
										<span class="nav-link-text ps-1">Overlay scrollbar</span>
									</div>
								</a>
								<!-- more inner pages-->
							</li>
							...
							<li class="nav-item">
								<a class="nav-link" href="modules/utilities/vertical-rule.html">
									<div class="d-flex align-items-center">
										<span class="nav-link-text ps-1">Vertical rule</span>
									</div>
								</a>
								<!-- more inner pages-->
							</li>
							...
							<li class="nav-item">
								<a class="nav-link" href="modules/utilities/visually-hidden.html">
									<div class="d-flex align-items-center">
										<span class="nav-link-text ps-1">Visually hidden</span>
									</div>
								</a>
								<!-- more inner pages-->
							</li>
						...
						<!-- parent pages--><a class="nav-link" href="widgets.html" role="button">
							<div class="d-flex align-items-center">
								<span class="nav-link-icon"><span class="fas fa-poll"></span></span><span
						...
						<ul class="nav collapse" id="multi-level">
							...
							<li class="nav-item">
								...
								<ul class="nav collapse" id="level-three">
									...
									<li class="nav-item">
										<a class="nav-link dropdown-indicator" href="#item-4" data-bs-toggle="collapse"
							...
							<li class="nav-item">
								...
								<ul class="nav collapse" id="level-four">
									...
									<li class="nav-item">
										<a class="nav-link dropdown-indicator" href="#item-7" data-bs-toggle="collapse"
					...
					<li class="nav-item">
						...
						<!-- parent pages--><a class="nav-link dropdown-indicator" href="#customization" role="button"
							...
							<div class="d-flex align-items-center">
								<span class="nav-link-icon"><span class="fas fa-wrench"></span></span><span
