<template>
    <Teleport to="body">
        <ul v-if="toastStore.toasts.length" class="toaster__wrapper">
            <li v-for="toast in toastStore.toasts" :class="['toaster__inner', toastClassMap[toast.status]]"
                :key="toast.text">
                <!-- <Icon
...
import type { TToastStatus } from "@/stores/toastifyStore";
import useToasterStore from "@/stores/toastifyStore";
